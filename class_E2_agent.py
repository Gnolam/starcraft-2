from class_E1_orders import EconomicOrders
from pysc2.lib import actions, units
import numpy as np
import random


class AgentBob(EconomicOrders):
    ...
    #     logging.getLogger(self.agent_name).info(f"AgentBob.init({__name__})")
    #     super(AgentBob, self).__init__(cfg)

    # def step(self, obs):
    #     ## print("step at AgentBob (%s)" % self.agent_name)
    #     return super(AgentBob, self).step(obs)
